...
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/nix/store/jhbxh1jwjc3hjhzs9y2hifdn0rmnfwaj-nix-2.3.15/bin:/nix/store/xvvgw9sb8wk6d2c0j3ybn7sll67s3s4z-bash-4.4-p23/bin:/nix/store/0g5glbq80jlqivddgv6hjqxyky93l6q7-dapp-0.34.0/bin:/nix/store/c02vzqpc85nkwj0iwirgyvr0ls3g5jl3-seth-0.10.1/bin:/nix/store/xqb54p9vskabw9fl336gp4byair7vw57-hevm-0.48.0/bin:/nix/store/0cm78dg7dalbaag7lkkl851krmdmg52c-solc-static-0.8.7/bin
RUN touch .bashrc
